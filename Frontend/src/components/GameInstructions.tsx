    ...
    <div className="space-y-4 text-white pb-4">
      ...
      <Card className="bg-gray-900/40 border-gray-700">
        ...
        <CardContent className="text-sm text-gray-300 pt-0">
          <p className="mb-2">
            <strong className="text-white">Goal:</strong> Choose a number
            closest to <strong>2/3 of the average</strong> of all submitted
            numbers.
          </p>
          <p className="text-blue-300">
            💡 <strong>Strategy Tip:</strong> Think about what others will
            choose, then choose 2/3 of that!
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="bg-gray-900/40 border-gray-700">
        ...
        <CardContent className="space-y-2 text-sm pt-0">
          <div className="flex items-start space-x-3">
            <Badge
              variant="outline"
              className="bg-blue-500/20 text-blue-300 border-blue-500 mt-1"
            >
              1
            </Badge>
            <div>
              ...
              <p className="text-gray-300">
                At least 3 players must join (max 15). Pay 0.01 ETH entry fee.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            <Badge
              variant="outline"
              className="bg-purple-500/20 text-purple-300 border-purple-500 mt-1"
            >
              2
            </Badge>
            <div>
              ...
              <p className="text-gray-300">
                Choose your number (0-1000) secretly. Numbers are encrypted
                until reveal.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            <Badge
              variant="outline"
              className="bg-orange-500/20 text-orange-300 border-orange-500 mt-1"
            >
              3
            </Badge>
            <div>
              ...
              <p className="text-gray-300">
                Reveal your original number to prove your commitment.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-3">
            <Badge
              variant="outline"
              className="bg-green-500/20 text-green-300 border-green-500 mt-1"
            >
              4
            </Badge>
            <div>
              ...
              <p className="text-gray-300">
                Winner is determined and can withdraw their prize!
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card className="bg-gray-900/40 border-gray-700">
        ...
        <CardContent className="text-sm text-gray-300 space-y-1 pt-0">
          <div className="flex items-center space-x-2">
            ...
            <span>
              <strong>Commit-Reveal:</strong> Your number is hidden until
              everyone submits
            </span>
          </div>
          <div className="flex items-center space-x-2">
            <CheckCircle className="h-5 w-5 text-emerald-400" />
            <span>
              <strong>Blockchain Verified:</strong> All calculations are
          ...
          <div className="flex items-center space-x-2">
            <CheckCircle className="h-5 w-5 text-emerald-400" />
            <span>
              <strong>No Cheating:</strong> Early exits allowed only before game
              starts
            </span>
          </div>
        </CardContent>
        ...
        <CardContent className="text-sm pt-0">
          <ol className="space-y-2 text-gray-300">
            <li className="flex items-start space-x-2">
              <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mt-0.5 flex-shrink-0">
                1
              </span>
              <span>
                Connect your MetaMask wallet to the Hardhat Local network
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mt-0.5 flex-shrink-0">
            ...
            <li className="flex items-start space-x-2">
              ...
              <span>
                Choose your strategic number and submit during commit phase
              </span>
            </li>
            <li className="flex items-start space-x-2">
              <span className="bg-blue-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs mt-0.5 flex-shrink-0">
            ...
            <li className="flex items-start space-x-2">
              ...
              <span>
                If you win, withdraw your prize from the smart contract!
              </span>
            </li>
          </ol>
        </CardContent>
